...
function FileUpload(props) {
  ...
  if (useMediaQuery(theme.breakpoints.up('xs')) && placeholderCompatibilityProps !== null && placeholderCompatibilityProps !== void 0 && placeholderCompatibilityProps.xs) {
    imageDimension = placeholderCompatibilityProps.xs;
  }
  if (useMediaQuery(theme.breakpoints.up('sm')) && placeholderCompatibilityProps !== null && placeholderCompatibilityProps !== void 0 && placeholderCompatibilityProps.sm) {
    imageDimension = placeholderCompatibilityProps.sm;
  }
  if (useMediaQuery(theme.breakpoints.up('md')) && placeholderCompatibilityProps !== null && placeholderCompatibilityProps !== void 0 && placeholderCompatibilityProps.md) {
    imageDimension = placeholderCompatibilityProps.md;
  }
  if (useMediaQuery(theme.breakpoints.up('lg')) && placeholderCompatibilityProps !== null && placeholderCompatibilityProps !== void 0 && placeholderCompatibilityProps.lg) {
  ...
  return /*#__PURE__*/React.createElement(Paper, _extends({
    ...
    ref: filesCardRef,
    variant: "outlined"
  }, containerCompatibilityProps), /*#__PURE__*/React.createElement(Typography, {
    gutterBottom: true,
    component: "div",
    color: "textSecondary",
    sx: {
  ...
  }, bannnerCompatibilityProps), /*#__PURE__*/React.createElement(Grid, {
    container: true,
    spacing: 2,
    alignItems: "center",
