(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/helpers/extends'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/slicedToArray'), require('react'), require('prop-types'), require('@mui/system'), require('@mui/material'), require('@mui/material/styles'), require('@mui/icons-material/Close'), require('@mui/icons-material/ArchiveOutlined'), require('@mui/icons-material/PlayCircleOutline'), require('@mui/icons-material/InsertDriveFileOutlined')) :
  typeof define === 'function' && define.amd ? define(['@babel/runtime/helpers/extends', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/slicedToArray', 'react', 'prop-types', '@mui/system', '@mui/material', '@mui/material/styles', '@mui/icons-material/Close', '@mui/icons-material/ArchiveOutlined', '@mui/icons-material/PlayCircleOutline', '@mui/icons-material/InsertDriveFileOutlined'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["react-material-fileuploader"] = factory(global._extends, global._toConsumableArray, global._slicedToArray, global.React, global.PropTypes, global.system, global.material, global.styles, global.CloseIcon, global.ArchiveOutlinedIcon, global.PlayCircleOutlineIcon, global.InsertDriveFileOutlinedIcon));
})(this, (function (_extends, _toConsumableArray, _slicedToArray, React, PropTypes, system, material, styles, CloseIcon, ArchiveOutlinedIcon, PlayCircleOutlineIcon, InsertDriveFileOutlinedIcon) { 'use strict';
  ...
  function FileUpload(props) {
    ...
    return /*#__PURE__*/React__default["default"].createElement(system.ThemeProvider, {
      theme: theme
    }, /*#__PURE__*/React__default["default"].createElement(material.Paper, _extends__default["default"]({
      sx: {
        p: 1
      },
      elevation: 0,
